...
from models.model_trans.transbts.TransBTS.PositionalEncoding import LearnedPositionalEncoding, FixedPositionalEncoding
from models.model_trans.transbts.TransBTS.Transformer import TransformerModel
from models.model_trans.transbts.TransBTS.Unet_skipconnection import Unet
...
# def TransBTS(img_dim, patch_dim, embedding_dim, hidden_dim, num_heads, _conv_repr=True, _pe_type="learned"):
#     num_classes = 1
#     num_channels = 1
#     aux_layers = [1, 2, 3, 4]
#
...
def TransBTS(img_dim=64, num_classes=1, _conv_repr=True, _pe_type="learned"):
    num_channels = 1
    patch_dim = 8
    aux_layers = [1, 2, 3, 4]
    model = BTS(
